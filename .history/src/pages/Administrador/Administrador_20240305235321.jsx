...
function Administrador() {
  ...
  const usuariosPendientes = datosUsuarios.filter((usuario) => usuario.aprobar ===false);
  const usuariosAprobados = datosUsuarios.filter((usuario) => usuario.aprobar ===true);
  const usuariosRechazados = datosUsuarios.filter((usuario) => usuario.rechazar===false);
