...
function Administrador() {
  ...
  const usuariosAceptados = datosUsuarios.find(user => user.username === username && user.password === password);
      ...
      <div className="contenedor__administrador"> 
        ...
        <div className="administrador__navbar">
          ...
          <div className="tablas__informativas">
            ...
            {opcionSeleccionada === 'UsuariosAceptados' && <Tabla datos={usuariosAceptados} />}
            {opcionSeleccionada === 'UsuariosAceptados' && <TablaOpciones datos={usuariosAceptados} />}
            {opcionSeleccionada === 'UsuariosAceptados' && <TablaOpciones datos={usuariosAceptados} />}
            </div>
        </div>
      </div>
