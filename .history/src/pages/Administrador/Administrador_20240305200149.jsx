...
function Administrador() {
  ...
  const opcionesBotonAceptar = {
    // Define las opciones para el botón de aceptar
    // Pueden ser propiedades específicas que necesitas para el botón de aceptar
  };
  ...
  const usuariosCoordinadores = datosUsuarios.filter((usuario) => !usuario.tipo=== "Administrador");
