...
import './login.css'
import { FaRegister, FaKey  } from "react-icons/fa";
    ...
    <div>
        <div className="login__container">
            ...
            <div className="logo__municipio">
                ...
                <InputTexto Icono={<FaRegister/>} Placeholder="Register Name"/>
                </div>
                </div>
                <div className="form form__RegisterName">
                <div className="input__RegisterName">
                <InputTexto Icono={<FaRegister/>} Placeholder="Cedula"/>
                </div>
                </div>
                ...
                <div className="form form__acept">
                    <div className="button__acept">
                        <BotonAcceso Icono={<RiLoginCircleLine />} NombreBoton='Registrarse'/>
                    </div>
                </div>
