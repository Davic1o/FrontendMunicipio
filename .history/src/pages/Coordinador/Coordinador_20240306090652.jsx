...
import ListarSectoresApi from '../../api/ListarSectoresApi'; // Asegúrate de tener la ruta correcta
...
function Coordinador() {
  ...
  const datosSectores = ListarSectoresApi(); // Llamada a la función para obtener datos
      ...
      <div className="contenedor__administrador">
        ...
        <div className="administrador__navbar">
          ...
          <div className="tablas__informativas">
            ...
            {opcionSeleccionada === 'Asistencias' && <Asistencias datos={usuarios} />}
          </div>
        </div>
      </div>
    </>
